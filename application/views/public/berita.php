                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4 wow animated fadeInUp" data-wow-delay=".3s">
                        <article class="single-blog-post">
                            ...
                            <div class="post-meta">
                                <!-- Title -->
                                <a href="<?php echo site_url('berita/detail/').url_title($news->judul,'dash',true);?>"><h2 class="subtitle"><?php echo $news->judul;?></h2></a>
                            ...
                            <div class="meta-tags">
                              ...
                              <!-- Read More -->
                              <a class="btn btn-round btn-fab" href="<?php echo site_url('berita/detail/').url_title($news->judul,'dash',true);?>"><i class="material-icons mdi mdi-arrow-right"></i><div class="ripple-container"></div></a>
                            </div>
                        </article>
                    </div>
                    <?php endforeach;?>
